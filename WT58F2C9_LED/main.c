...
int main()
{
	...
	for (i=0; i<3; i++)
	{
		GPIO_PTB_GPIO = 0x7ffe; // 0/1: LED on/off
		delay1(200000);
		GPIO_PTB_GPIO = 0xbffd;
		delay1(200000);
		GPIO_PTB_GPIO = 0xdffb;
		delay1(200000);
		GPIO_PTB_GPIO = 0xeff7;
		delay1(200000);
		GPIO_PTB_GPIO = 0xf7ef;
		delay1(200000);
		GPIO_PTB_GPIO = 0xfbdf;
		delay1(200000);
		GPIO_PTB_GPIO = 0xfdbf;
		delay1(200000);
		GPIO_PTB_GPIO = 0xfe7f;
		delay1(200000);
		GPIO_PTB_GPIO = 0xfdbf;
		delay1(200000);
		GPIO_PTB_GPIO = 0xfbdf;
